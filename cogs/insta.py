...
class Insta(commands.Cog):
    ...
    async def on_message(self, message):
        ...
        try:
            ...
            message.channel.send(f"Unable to download post; error is {e}") 
            pass
        ...
        for filename in os.listdir(directory):
            ...
            message.channel.send(f"Unable  to clean the directory after downloading images; error is {e}")
            pass
        ...
        for filename in os.listdir(directory):
            ...
            message.channel.send(f"Unable to send media; error is {e}")
            return
def setup(bot):
